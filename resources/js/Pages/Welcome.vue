                    ...
                    >
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Importe seus contatos de arquivos CSV com facilidade. Nosso sistema lida com a deduplicação,
                                valida os dados e fornece uma interface bonita para gerenciar seus contatos.
                                Comece fazendo login ou registrando uma conta.
                            </p>
                        </div>
                    </div>
                </div>
